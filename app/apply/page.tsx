...
export default function ApplyPage() {
    ...
    return (
        <main className="px-4 lg:px-9">
            ...
            {/* ── Form ── */}
            <section className="pb-24 px-6 md:px-12 lg:px-24 max-w-3xl mx-auto">
                <form onSubmit={handleSubmit} className="space-y-8">

                    {/* Full Name */}
                    <div>
                        <label htmlFor="fullName" className="block text-base font-semibold text-black mb-2">
                            Full Name
                        </label>
                        <input
                            id="fullName"
                            ...
                            className="w-full rounded-xl border border-gray-300 px-5 py-4 text-base text-black placeholder:text-gray-400 focus:outline-none focus:border-brandPurple focus:ring-2 focus:ring-brandPurple/20 transition-all duration-200"
                        />
                    </div>
                    ...
                    {/* Phone */}
                    <div>
                        <label htmlFor="phone" className="block text-base font-semibold text-black mb-2">
                            Phone Number
                        </label>
                        <input
                            id="phone"
                    ...
                    {/* Motivation */}
                    <div>
                        <label htmlFor="motivation" className="block text-base font-semibold text-black mb-2">
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            className="w-full rounded-xl border border-gray-300 px-5 py-4 text-base text-black placeholder:text-gray-400 focus:outline-none focus:border-brandPurple focus:ring-2 focus:ring-brandPurple/20 transition-all duration-200 resize-none"
                        />
                    </div>

                    {/* Goals */}
                    <div>
                        <label htmlFor="goals" className="block text-base font-semibold text-black mb-2">
                            ...
                            {['None', 'Beginner', 'Some experience'].map((option) => (
                                <label
                                    ...
                                    className={`flex-1 cursor-pointer rounded-xl border-2 px-5 py-4 text-center font-medium transition-all duration-200 ${form.experience === option
                                            ? 'border-brandPurple bg-brandPurple/5 text-brandPurple'
                    ...
                    {/* Referral */}
                    <div>
                        <label htmlFor="referral" className="block text-base font-semibold text-black mb-2">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-brandPurple text-white font-bold py-5 rounded-full text-lg hover:opacity-90 transition-all duration-300 shadow-md hover:shadow-lg mt-4 cursor-pointer"
                    >
                        Submit Application
                    </button>
