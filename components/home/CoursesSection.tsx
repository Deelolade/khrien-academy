            ...
            <div className="max-w-360 mx-auto">
                ...
                <div className="mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white shadow-md border duration-300 text-center p-8 rounded-2xl border-brandPurple/40 transition-colors">
                        ...
                        <Link
                            href="#"
                            className="bg-brandPurple text-white font-semibold px-10 py-3 rounded-full hover:opacity-90 transition-all duration-300 text-lg shadow-md hover:shadow-lg"
                        >
                            Explore Course
                        </Link>
                    </div>
